...
import { Clock, Calculator, ArrowRight, RefreshCw, Calendar, Cloud, Skull, Navigation, MapPin, Shield } from 'lucide-react'
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-2xl">
          ...
          <p className="text-xl text-blue-100">
            6 Powerful Tools: Time • Age • Statistics • Weather • Maps • Cameras
          </p>
          </div>

          {/* Calculator Card */}
          <div className="glass rounded-3xl p-8 shadow-2xl animate-slide-up">
            {/* Minute Calculator Header */}
            <div className="text-center mb-6">
              <h2 className="text-3xl font-bold text-white mb-2">⏱️ Minute Calculator</h2>
              <p className="text-blue-100">Calculate precise time differences between any two times</p>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                  <Link
                    href="/age-calculator"
                    className="text-center bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg"
                  >
          ...
          <div className="text-center mt-8 text-blue-100 animate-fade-in">
            <p>Complete toolkit: Time calculations • Live age tracking • Global statistics • Real weather • Street View exploration • Traffic monitoring</p>
            <p className="text-sm mt-2 opacity-80">All tools designed with modern UI and real-time updates</p>
          </div>
        </div>
      </div>
    </div>
